...
export class AddAuthTables1789587141274 implements MigrationInterface {
  name = 'AddAuthTables1789587141274';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);

    await queryRunner.query(
      `CREATE TYPE "public"."roles_name_enum" AS ENUM('ADMIN', 'SUPERVISOR', 'TECHNICIAN', 'VIEWER')`,
    );
    await queryRunner.query(
